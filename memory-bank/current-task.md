...
* **2026-06-16**: Khoi tao Git repository cuc bo va them remote `origin` toi `git@github.com:haofordev/caychaytutien.git`.
* **2026-06-16**: Bổ sung thiết kế Ngũ Hệ Linh Căn: người chơi chọn miễn phí 1 hệ Kim/Mộc/Thủy/Hỏa/Thổ sau Khảo Nghiệm Linh Căn, các hệ còn lại mở bằng nhiệm vụ theo cảnh giới, tài nguyên và bí cảnh; cập nhật `game-design.md`, `game-rules/cultivation.md` và ADR-008.
