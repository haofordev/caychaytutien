...
* **Thiên phú độc quyền: Dược Đạo Chi Tâm**
  ...
  * Tỷ lệ gieo trồng/nuôi dưỡng linh dược thành công: **+20%**, giảm rủi ro héo úa và sâu bệnh.
...
* **Thiên phú độc quyền: Bất Diệt Thánh Thể**
  * Thể lực tối đa: **+30%**.
  * Tiêu hao thể lực khi khai khoáng: **-20%**.
  * Sản lượng khoáng thạch khai thác trong mỏ khoáng/Linh mạch: **+50%**.
...
* **Thiên phú độc quyền: Huyết Sát Chi Thể**
  * Hút HP khi săn bắn: hồi phục **15%** sát thương gây ra lên yêu thú.
  * Giảm hao tổn HP sau mỗi lượt săn bắn/bí cảnh: **-20%**.
...
### 2.1. Ngũ Hệ Linh Căn và Hướng Tu Luyện

Đạo lộ quyết định phong cách phát triển tổng thể, còn **Linh Căn** quyết định hệ công pháp, tài nguyên ưu tiên và bonus tu luyện theo ngũ hành. Mọi người chơi, dù chọn Đạo Tu, Thể Tu hay Ma Tu, đều có thể mở đủ 5 hệ linh căn nếu hoàn thành điều kiện tương ứng.

Khi bắt đầu game, sau **Khảo Nghiệm Linh Căn sơ bộ**, người chơi được chọn miễn phí **1 hệ linh căn khởi nguyên**. Hệ này ở trạng thái tiềm ẩn cho đến khi người chơi học được công pháp nhập môn và bắt đầu dẫn khí nhập thể:

| Hệ linh căn | Chủ đề | Bonus chính | Hướng build |
| :--- | :--- | :--- | :--- |
| **Kim Linh Căn** | Canh kim, kiếm khí, pháp bảo | Tăng sát thương, xuyên giáp, hiệu quả rèn khí | Pháp bảo, kiếm tu, PVP chiếm mỏ |
| **Mộc Linh Căn** | Sinh cơ, linh dược, hồi phục | Tăng sinh trưởng linh điền, hồi phục, luyện đan dưỡng thân | Trồng dược, luyện đan, tu luyện bền |
| **Thủy Linh Căn** | Hàn lưu, điều tức, khống chế | Tăng hồi linh khí, giảm debuff, khống chế mục tiêu | Phòng thủ mềm, kiểm soát, đi bí cảnh |
| **Hỏa Linh Căn** | Chân hỏa, luyện đan, bộc phát | Tăng sát thương bạo phát, luyện đan, thiêu đốt | Farm nhanh, luyện đan công kích |
| **Thổ Linh Căn** | Địa mạch, trận pháp, phòng ngự | Tăng phòng thủ, hiệu quả động phủ/trận pháp, ổn định đột phá | Chống lôi kiếp, trụ vững, xây động phủ |

**Quy tắc khởi đầu:**
* Người chơi chỉ có **1 hệ linh căn đang mở** khi vào game.
* Hệ đầu tiên là lựa chọn miễn phí, không tiêu tốn tài nguyên, không phụ thuộc đạo lộ.
* Phẩm chất linh căn ban đầu mặc định là **Tạp Linh Căn**; phẩm chất quyết định tốc độ tu luyện, còn hệ linh căn quyết định hướng build.
* Người chơi có thể trang bị công pháp cùng hệ để nhận bonus đầy đủ. Công pháp khác hệ vẫn học được nhưng hiệu quả giảm cho đến khi mở hệ tương ứng.

### 2.2. Điều Kiện Mở Thêm Hệ Linh Căn

Mở thêm linh căn là tuyến nhiệm vụ dài hạn. Mỗi hệ mới yêu cầu người chơi chứng minh đủ cảnh giới, tài nguyên và trải nghiệm gameplay thay vì chỉ bấm mua.

| Số hệ đã mở | Mốc mở khóa | Điều kiện nhiệm vụ | Chi phí đề xuất | Kết quả |
| :--- | :--- | :--- | :--- | :--- |
| **Hệ 1** | Sau Khảo Nghiệm Linh Căn | Hoàn thành tạo nhân vật, hệ linh căn ở trạng thái tiềm ẩn cho đến khi học công pháp nhập môn | Miễn phí | Chọn 1 trong 5 hệ Kim/Mộc/Thủy/Hỏa/Thổ |
| **Hệ 2** | Luyện Khí Tầng 3 | Hoàn thành nhiệm vụ `Ngũ Hành Sơ Tỉnh`: thắng 3 kỳ ngộ thuộc hệ muốn mở | 200 Linh thạch + 20 tinh hoa hệ tương ứng | Mở hệ thứ hai, học công pháp cấp thấp cùng hệ |
| **Hệ 3** | Luyện Khí Tầng 7 | Sở hữu Động Phủ, dựng `Tụ Linh Trận` cấp 1 và hoàn thành 1 bí cảnh ngũ hành | 500 Linh thạch + 50 tinh hoa hệ tương ứng | Mở hệ thứ ba, tăng lựa chọn công pháp/trận pháp |
| **Hệ 4** | Trúc Cơ Sơ Kỳ | Vượt `Bí Cảnh Ngũ Hành` tầng 3 và chống chịu một lần lôi kiếp thành công | 1,500 Linh thạch + 100 tinh hoa hệ tương ứng | Mở hệ thứ tư, kích hoạt combo song/tam hệ nâng cao |
| **Hệ 5** | Trúc Cơ Hậu Kỳ | Hoàn thành chuỗi `Ngũ Khí Triều Nguyên`: thu thập đủ 5 loại tinh hoa và đánh bại thủ hộ hệ cuối | 5,000 Linh thạch + 1 Ngũ Hành Lệnh | Mở đủ ngũ hệ, cho phép tu luyện công pháp ngũ hành hoàn chỉnh |

**Tinh hoa hệ** nhận từ hoạt động phù hợp:
* Kim: khai khoáng, rèn khí, PVP linh mạch.
* Mộc: linh điền, luyện đan, kỳ ngộ thảo dược.
* Thủy: bí cảnh hồ/đầm, nhiệm vụ điều tức, chữa debuff.
* Hỏa: luyện đan, săn yêu thú hỏa thuộc tính, vượt thử thách chân hỏa.
* Thổ: nâng động phủ, trận pháp, phòng thủ lôi kiếp.

### 2.3. Combo Linh Căn và Giới Hạn Cân Bằng

Mỗi hệ mở thêm tạo thêm lựa chọn build, nhưng bonus không cộng dồn vô hạn. Người chơi cần chọn **hệ chủ tu** và tối đa **2 hệ phụ tu đang kích hoạt** trong một thời điểm.

* **Hệ chủ tu:** nhận 100% bonus từ công pháp và thiên phú hệ.
* **Hệ phụ tu:** nhận 50% bonus từ công pháp/trận pháp/vật phẩm cùng hệ.
* **Hệ đã mở nhưng không kích hoạt:** cho phép học, chế tạo và dùng vật phẩm cùng hệ, nhưng không cộng bonus chiến đấu trực tiếp.
* Có thể đổi hệ chủ/phụ tại Động Phủ, cần thời gian điều tức để tránh đổi build liên tục trước PVP.

Combo gợi ý:
* **Kim + Hỏa:** sát thương bộc phát, hợp PVP và săn boss.
* **Mộc + Thủy:** hồi phục, luyện đan, đi đường dài an toàn.
* **Thổ + Kim:** phòng ngự cao, rèn pháp bảo, chống lôi kiếp.
* **Mộc + Hỏa:** luyện đan mạnh, tăng sản xuất đan dược.
* **Thủy + Thổ:** khống chế, trận pháp, thủ động phủ.

### 2.4. Giai Đoạn Phàm Nhân Lao Động

Tất cả người chơi vào game đều bắt đầu là **Phàm Nhân**, chưa thể tĩnh tọa hấp thu linh khí ngay. Linh căn đã chọn chỉ là tiềm năng trong đan điền, cần công pháp nhập môn để kích hoạt.

Mục tiêu đầu game:
1. Lao động kiếm tài nguyên thô.
2. Mua hoặc đổi được sách **Dẫn Khí Nhập Thể Quyết**.
3. Học công pháp để mở khóa tĩnh tọa, tu vi/giây và Động Phủ Tầng 1.

Tài sản khởi đầu của phàm nhân:
* **1 ô sân nhà Thanh Vân**: trồng linh dược thô và nuôi 1 linh thú non.
* **1 mỏ khoáng cạn**: khai thác khoáng thạch thô; mỗi lượt khai khoáng tiêu hao thể lực.
* **1 bí cảnh ngoại vi**: săn yêu thú yếu để nhận da thú, thịt thú, yêu đan vỡ và cơ hội bắt linh thú non.
* **Thể lực ngày**: dùng cho khai khoáng và săn bắn; hồi theo thời gian hoặc qua thức ăn/đan dược thấp cấp.

Định hướng đạo lộ ở giai đoạn phàm nhân:
* **Đạo Tu** thiên về trồng linh dược: tỷ lệ gieo trồng thành công cao, dược liệu ít héo, dễ tích lũy nguyên liệu luyện đan.
* **Thể Tu** thiên về khai khoáng: thể lực cao hơn, đào lâu hơn, sản lượng khoáng và linh thạch vụn tốt hơn.
* **Ma Tu** thiên về săn bắn: hút HP khi đánh yêu thú, giảm hao máu, farm yêu đan và thú non tốt hơn.
...
1. **Phàm Nhân** (Khởi đầu) $\rightarrow$ Lao động kiếm tài nguyên, mua/học **Dẫn Khí Nhập Thể Quyết** để mở tu luyện.
2. **Luyện Khí** (Tầng 1 $\rightarrow$ Tầng 9): Bước đầu dẫn khí nhập thể, bắt đầu có Tu Vi/giây và mở Thông Thiên Động Phủ Tầng 1.
...
- Tĩnh Tọa Hấp Thu           - Sân nhà Phàm Nhân             - Tranh Đoạt Linh Mạch
- Tụ Linh Trận (Động phủ)    - Dược viên/Mỏ/Bí cảnh tầng     - PK cướp tài nguyên
- Offline income (Tối đa 8h) - Luyện Đan & Luyện Khí Các     - Tông Môn Chiến
```

### 5.1. Phàm Nhân Lao Động & Công Pháp Nhập Môn
Trước khi chính thức tu tiên, người chơi chưa có Tu Vi/giây và chưa thể tĩnh tọa. Họ phải dùng sức lao động phàm nhân để kiếm tài nguyên mua công pháp.

Hoạt động khởi đầu:
* **Trồng linh dược thô:** dùng ô sân nhà để gieo Tụ Linh Thảo non, Linh Mạch Cỏ, dược liệu cấp thấp. Đạo Tu có tỷ lệ trồng thành công và chất lượng thu hoạch cao hơn.
* **Nuôi linh thú non:** cho ăn thảo dược/khoáng vụn để nhận nguyên liệu, hoặc giữ lại làm trợ thủ sau này.
* **Khai mỏ khoáng cạn:** tiêu hao thể lực để nhận khoáng thạch thô, linh thạch vụn. Thể Tu có thể lực cao hơn và khai thác hiệu quả hơn.
* **Vào bí cảnh ngoại vi săn bắn:** tiêu hao thể lực/HP để săn yêu thú yếu. Ma Tu có hút HP nên sống sót và farm yêu đan tốt hơn.

Mốc nhập môn:
* Khi tích đủ tài nguyên, người chơi mua **Dẫn Khí Nhập Thể Quyết** từ tán tu, chợ thôn hoặc phần thưởng bí cảnh.
* Học công pháp xong sẽ mở khóa **Tĩnh Tọa Hấp Thu**, thanh Tu Vi, cảnh giới **Luyện Khí Tầng 1** và quyền nhận ô **Thông Thiên Động Phủ Tầng 1**.

### 5.2. Tĩnh Tọa Hấp Thu (Cultivate - Idle)
* **Mô tả:** Sau khi học công pháp nhập môn, người chơi có thể bấm nút "Tĩnh Tọa" để nhân vật tự động hấp thu linh khí thiên địa và chuyển hóa thành Tu Vi mỗi giây.
...
### 5.3. Động Phủ Phân Tầng (Abode - Active & Social)
Động phủ của tu sĩ được quy hoạch chung tại **Thông Thiên Tháp Động Phủ** để chia sẻ linh mạch cốt lõi thời Mạt Pháp.
* **Mở khóa Tầng 1**: Sau khi học **Dẫn Khí Nhập Thể Quyết**, người chơi được cấp/mua ô Động Phủ Tầng 1 đầu tiên. Sân nhà phàm nhân được chuyển thành khu phụ trợ, không còn là nguồn buff chính.
...
* **Phân khu chức năng theo tầng**: Mỗi tầng có 1 bộ hoạt động riêng gồm **Dược Viên**, **Mỏ Khoáng**, **Bí Cảnh**, **Yêu Vực** và **Đan/Luyện Các**. Tầng càng cao thì sản lượng tốt hơn, nhưng thời gian/độ nguy hiểm/chi phí cũng tăng.

| Phân khu tầng | Vai trò | Đạo lộ tối ưu | Buff theo tầng |
| :--- | :--- | :--- | :--- |
| **Dược Viên** | Trồng linh dược, hạt giống quý, nguyên liệu luyện đan | Đạo Tu | Tăng tốc sinh trưởng và phẩm chất dược liệu |
| **Mỏ Khoáng** | Khai khoáng cá nhân, nhận khoáng thạch và linh thạch vụn | Thể Tu | Tăng sản lượng, giảm hao thể lực mỗi lượt đào |
| **Bí Cảnh** | Săn yêu thú, nhặt công pháp/tàn quyển, bắt thú non | Ma Tu | Tăng phẩm cấp quái, tỷ lệ rơi yêu đan và công pháp |
| **Yêu Vực** | Nuôi linh thú/yêu thú non, thu nguyên liệu hoặc pet | Ma Tu/Đạo Tu | Tăng tốc trưởng thành, giảm hao thức ăn |
| **Đan/Luyện Các** | Luyện đan, rèn pháp bảo, chế vật phẩm chống lôi kiếp | Đạo Tu/Thể Tu | Tăng tỷ lệ thành công chế tạo |

### 5.4. Du Ngoạn Kỳ Ngộ (Text-based Adventure - Active)
...
### 5.5. Tranh Đoạt Linh Mạch Cực Phẩm (PVP - Resource Competition)
...
* **Hành động chính rõ ràng:** Lao động, Gieo trồng, Khai khoáng, Săn bắn, Tĩnh tọa, Đột phá, Thu hoạch, Xuất sơn, Chiếm mỏ, Dùng vật phẩm.
...
* Sau khi chọn đạo lộ, màn Khảo Nghiệm Linh Căn cho người chơi chọn miễn phí 1 hệ trong Kim, Mộc, Thủy, Hỏa, Thổ. Hệ đã chọn ở trạng thái tiềm ẩn cho đến khi học công pháp nhập môn; bốn hệ còn lại hiển thị trạng thái khóa kèm điều kiện nhiệm vụ mở khóa tiếp theo.
* Thẻ hệ linh căn cần hiển thị: tên hệ, bonus chính, tài nguyên liên quan, công pháp gợi ý và nút `Chọn hệ khởi nguyên`.

#### 6.8.2. Tu Luyện View
Mục tiêu: người chơi nhìn thấy tiến trình tăng tu vi và quyết định có nên đột phá hay chuẩn bị thêm.

Thành phần:
* Nếu chưa học công pháp nhập môn: hiển thị mục tiêu `Mua Dẫn Khí Nhập Thể Quyết`, tài nguyên còn thiếu và 3 CTA nhanh `Gieo trồng`, `Khai khoáng`, `Săn bắn`.
...
#### 6.8.3. Động Phủ View
Mục tiêu: quản lý tài sản cá nhân, từ sân nhà phàm nhân đến Thông Thiên Tháp, sản xuất tài nguyên và nâng tầng.

Thành phần:
* Trước khi nhập môn: header hiển thị `Sân nhà Thanh Vân`, ô dược nhỏ, mỏ cạn, bí cảnh ngoại vi và tiến độ mua công pháp.
* Sau khi nhập môn: header tầng hiển thị `Tầng X`, `Ô #Y`, bonus linh khí, độ kín tầng `n/100`.
* Nút `Nâng Tầng` mở modal danh sách tầng kế tiếp, giá mua, số ô còn trống, điều kiện cảnh giới.
* Segment control: `Dược Viên`, `Mỏ Khoáng`, `Bí Cảnh`, `Yêu Vực`, `Đan/Luyện`.
* Dược Viên: grid ô đất, mỗi ô có trạng thái `empty`, `growing`, `ready`, `diseased`.
* Mỏ Khoáng: hiển thị thể lực, độ bền mỏ, sản lượng dự kiến và nút khai thác.
* Bí Cảnh: danh sách ải săn bắn theo tầng, độ nguy hiểm, HP dự kiến hao tổn và phần thưởng.
...
* Auth, chọn đạo lộ, chọn linh căn khởi nguyên, header trạng thái nhân vật.
* Trạng thái phàm nhân lao động và mục tiêu mua công pháp nhập môn.
* Bottom navigation 5 tab.
* Socket connect/reconnect banner.

#### Giai đoạn 2: Core Loop Tu Luyện
* Sân nhà phàm nhân: gieo trồng, khai khoáng, săn bắn để mua `Dẫn Khí Nhập Thể Quyết`.
* Tu Luyện View, progress tu vi realtime, tĩnh tọa sau khi học công pháp.
* Modal đột phá, hiển thị tỷ lệ và rủi ro.
* Event log gameplay.

#### Giai đoạn 3: Sản Xuất Động Phủ
* Động Phủ View, tầng/ô đất, nâng tầng.
* Dược Viên, Mỏ Khoáng, Bí Cảnh tầng, Yêu Vực 3 chuồng, Đan/Luyện.
